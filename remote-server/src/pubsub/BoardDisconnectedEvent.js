...
exports.default = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    const connectedBoardIos = yield BoardIOModel_1.BoardIo.find({ board: id });
    for (const boardIo of connectedBoardIos) {
        yield pubSub_1.default.publish(pubSub_1.EVENTS.BOARD_IO.CHANGED, { BoardIoChanged: { boardIo, connected: false } });
    }
});
